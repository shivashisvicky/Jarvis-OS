(()=>{
'use strict';
if(window.__JARVIS_COMMAND_DETERMINISTIC_FIX_V4__)return;
window.__JARVIS_COMMAND_DETERMINISTIC_FIX_V4__=true;
...
const destination=q=>q.replace(/^\s*(?:please\s+)?(?:take me to|take me|navigate me to|directions? to|navigate to|go to|open maps? for|find|locate|where is|where are|look for|show me)\s+/i,'').trim();
