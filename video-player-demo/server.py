...
def search_video(query: str) -> dict:
    """Return the first real YouTube result and a current direct media URL."""
    opts = [
        sys.executable,
        "-m",
        "yt_dlp",
    ...
    try:
        ...
        raise RuntimeError("video search timed out") from exc
...
class Handler(BaseHTTPRequestHandler):
    server_version = "JarvisVideoDemo/1.0"
    ...
    def do_GET(self) -> None:  # noqa: N802
        ...
        if parsed.path == "/api/search":
            ...
            except Exception as exc:  # keep the demo API honest and debuggable
