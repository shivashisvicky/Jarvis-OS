(()=>{
'use strict';
if(window.__JARVIS_COMMAND_AUTHORITY_V3__)return;
window.__JARVIS_COMMAND_AUTHORITY_V3__=true;
...
const route=q=>{
 ...
 if(strongBookQuery)return {type:'BOOKS',owner:'jarvis-ebook-command-authority-v1.js'};
