(()=>{
'use strict';
if(window.__JARVIS_COMMAND_AUTHORITY_V1__)return;
window.__JARVIS_COMMAND_AUTHORITY_V1__=true;
...
const route=q=>{
 ...
 if(/\b(?:restaurant|restaurants|hotel|hospital|pharmacy|school|bank|atm|fuel|gym|supermarket|temple)\b/.test(s)&&/\b(?:in|near|around|at)\b/.test(s))return {type:'MAP_POI',owner:'jarvis-command-final-routing-v2.js'};
...
window.jarvisCommandAuthority=Object.freeze({version:'1.0.0',route:snapshot,get:()=>({...window.__JARVIS_COMMAND_ROUTE__})});
