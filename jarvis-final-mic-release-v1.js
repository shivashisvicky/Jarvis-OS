(()=>{
'use strict';
if(window.__JARVIS_FINAL_MIC_RELEASE_V1__)return;
window.__JARVIS_FINAL_MIC_RELEASE_V1__=true;
...
const hardStop=()=>{for(const r of Array.from(sessions))abort(r);sessions.clear();try{window.jarvisStopIOSVoice?.()}catch{}cancelSpeech();hide()};
