(() => {
  ...
  style.textContent = `.jarvis-game-pad{display:grid;grid-template-columns:repeat(3,48px);grid-template-rows:42px 42px auto;grid-template-areas:". up ." "left down right" "wide wide wide";gap:6px;justify-content:center;margin:10px auto 0}.jarvis-game-pad button{width:48px;height:42px;padding:0;font-size:18px;touch-action:manipulation;-webkit-tap-highlight-color:transparent}.jarvis-game-pad button[data-dir="ArrowLeft"],.jarvis-game-pad button[data-key="ArrowLeft"]{grid-area:left}.jarvis-game-pad button[data-dir="ArrowUp"],.jarvis-game-pad button[data-key="ArrowUp"]{grid-area:up}.jarvis-game-pad button[data-dir="ArrowDown"],.jarvis-game-pad button[data-key="ArrowDown"]{grid-area:down}.jarvis-game-pad button[data-dir="ArrowRight"],.jarvis-game-pad button[data-key="ArrowRight"]{grid-area:right}.jarvis-game-pad .wide{grid-area:wide;width:100%;font-size:11px;letter-spacing:.08em}.jarvis-tetris-paused{opacity:.78}@media(max-width:600px){.jarvis-game-pad{grid-template-columns:repeat(3,52px);gap:7px}.jarvis-game-pad button{width:52px;height:44px}}`;
