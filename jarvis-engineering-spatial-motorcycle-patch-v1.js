...
function motorcyclePlan(){
 const z=.06,frame=.065,wheelR=.34,tube=.04;
 ...
 return {operations:[
  ...
  box('rear_swingarm',.62,.045,.06,.38,.43,172),
  box('rear_frame_rail',.56,.055,.065,.28,.61,160),
  box('seat_tube',.48,.065,.065,.10,.66,66),
  box('main_down_tube',.58,.065,.065,-.18,.53,148),
  box('upper_frame_tube',.58,.065,.065,-.08,.78,-165),
  box('head_tube',.18,.075,.075,-.48,.73,-110),
  box('front_fork',.42,.055,.055,-.57,.53,70),
  box('front_fork_lower',.35,.045,.05,-.53,.43,72),
